...
int main()
{
    // Configura a localização para português e define a cor do console
    setlocale(LC_ALL, "Portuguese");
    system("Color E0");// Define a cor do console (não é padrão C++, depende do sistema operacional)
    string Seletor = "s";// Variável para controle de repetição
    ...
    do{
        // Variáveis locais utilizadas para cada operação
        ...
        cout << "++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++" << endl;
        cin >> Valor1int;
        // Switch para selecionar a operação desejada
        switch(Valor1int){
            case 1:{
                // Cálculo de potência
        ...
        // Verifica se houve algum resultado a ser exibido
        if(Valor1float != 0)
        {
            cout << "Resultado " << Valor1float << endl;
        }
        // Solicita ao usuário se deseja realizar outro cálculo
        cout << "Digite s para fazer outro cálculo ou precione n para sair" << endl;
        cin >> Seletor;
        // Se o usuário deseja continuar, limpa a tela e exibe mensagem de novo cálculo
        if(Seletor == "s"){
            cout << "****************" << endl;
            cout << "*              *" << endl;
